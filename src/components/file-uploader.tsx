...
const FileUploader: React.FC<IFileUploader> = ({ fieldChange, mediaUrl, extensions = ['.png', '.jpeg', '.jpg', '.svg', '.webp', '.zip', '.pdf', '.mp4', '.mp3', '.txt'], is_multiple, size_limit, file_count, on_change, name, id, ref }) => {
    ...
    return (
        ...
        is_multiple ?
            ...
            <div {...getRootProps()} className="flex justify-start flex-col rounded-xl w-full">
                <input {...getInputProps()} className="w-full" name={name} id={id} />
                {file_urls.length > 0 ? (
                ...
                <input {...getInputProps()} name={name} />
                {
                    ...
                    file_url ?
                        ...
                        <div className="w-full h-[300px] bg-slate-400 rounded-2xl flex flex-col items-center justify-center">
                            ...
                            <Button variant={'default'} className="cursor-pointer" size={'default'} onClick={(e) => { e.preventDefault(); open() }}>Select from device</Button>
